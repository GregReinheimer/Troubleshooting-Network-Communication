...
**Step 6: Check the port 1 on the switch is blinking.**

![]

**Resolution: The Exec workstation had a bad NIC.**

**To find the issue with the Office 1 workstation, repeat steps 4 and 5. There no possible causes of a faulty NIC or cable on this machine. Try the third possible theory: poor cable on the switch and patch panel.**
